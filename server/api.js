...
const friendsListController = require('./apiFunc/friendsList')
const friendsRequestController = require('./apiFunc/friendsRequest')
...
const updateProvideController = require('./apiFunc/updateProvide')

router.post('/signUp', signUpController)
router.post('/logIn', logInController)
router.post('/userInfo', userInfoController)
router.post('/friendsInfoList', friendsInfoListController)
router.post('/friendsList', friendsListController)
router.post('/friendsRequest', friendsRequestController)
...
router.post('/updateProvide', updateProvideController)
